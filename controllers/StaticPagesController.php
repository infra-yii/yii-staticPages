...
class StaticPagesController extends Controller
{
	...
	{
		$this->render($this->getStaticPagesModule()->view,array(
	...
	{
		$dataProvider=new CActiveDataProvider($this->getStaticPagesModule()->modelClass);
	...
	{
        $c = $this->getStaticPagesModule()->modelClass;
		$model=new $c('search');
     ...
     */
    private function getStaticPagesModule() {
        return Yii::app()->getModule("staticPages");
    }
